...
### 相同的內容亦可見《建國以來毛澤東文稿》 第十三冊 第169頁 （中央文獻出版社）
源自馬克思主義文庫網站: 
...
依據事實，破除迷信。我們需要破除無神論和進化論這兩個最大的迷信。
...
國際教育發展組織（IED）在2001年8月14日的聯合國會議上提交了天安門自焚案的分析錄像帶，強烈譴責中共的“國家恐怖主義行為”，並發表聲明說：自焚事件的錄像分析表明，整個事件是“政府一手導演的”。中共代表面對確鑿證據，沒有辯辭。該聲明已被聯合國備案。
...
翻牆也叫科學上網，通過科學的方法繞過上網限制訪問。我們每個人都應該科學上網，我們置身於到處充斥著虛假信息的中國大陸局域網，再用常規的方法上網，就會被蒙蔽。
...
（那些全世界都在用的著名網站，比如：推特（twitter）、youtube、臉書（facebook）、谷歌（google）等，是一個言論自由的地方，這些網站有大量的為共產黨塗脂抹粉的內容，同時也有揭露共產黨邪惡罪行的內容，它不是只有一個聲音，共產黨控制不了它，因此被共產黨的網絡防火牆屏蔽掉了，中國網民能看到的，全部是只有一個聲音的謊言。）
...
配套視頻網址：[https://youtu.be/Z3l-g0_SSDk](https://youtu.be/Z3l-g0_SSDk)
